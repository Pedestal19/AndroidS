...
public class LandRegComplete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_land_reg_complete);
        ...
        btn_addbuilding.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(LandRegComplete.this, "Add Building", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
