...
public class PropertyList2 extends AppCompatActivity {
    private static final String TAG = "PropertyList2";
...
*/        new RemoteDataTask().execute();
    ...
    private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(PropertyList2.this);
            ...
            if(myList.size() > 0) {
                ...
                listView_taxpayers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        app.setActiveActivity(PropertyList2.this);
...
//                String tpID = cursor.getString(cursor.getColumnIndex("tax_registration_id"));
    ...
    void Info(){
        ...
        adb.setTitle("Info");
        adb.setIcon(R.mipmap.ic_launcher);
        adb.setMessage("Please select a property to add a building to");
