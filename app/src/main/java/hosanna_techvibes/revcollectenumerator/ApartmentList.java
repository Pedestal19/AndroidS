        ...
        if(app.getCommand()==null) {
            ...
            fabAddTaxPayer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    app.setActiveActivity(ApartmentList.this);
                    if(mode.isChecked()){
                        app.setReg_mode(true);
                        startActivity(new Intent(getApplicationContext(), AddApartment.class));
                    }
                    else{
                        startActivity(new Intent(getApplicationContext(), BuildingList2.class));
                    }                  }
            });
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(ApartmentList.this);
