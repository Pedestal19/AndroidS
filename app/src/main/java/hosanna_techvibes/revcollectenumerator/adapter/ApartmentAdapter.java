...
public class ApartmentAdapter extends BaseAdapter {
    ...
    public ApartmentAdapter(Context context, ArrayList<Taxpayer> myList) {
        this.myList = myList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mViewHolder.tvEmpID.setText(currentListData.getSurname());
        mViewHolder.tvFullName.setText(currentListData.getFirst_name());
        mViewHolder.tvViewDate.setText("No of Occupants: "+currentListData.getTemp_tax_id());
        if(currentListData.getTax_id() != null && !currentListData.getTax_id().equalsIgnoreCase("null") && !currentListData.getTax_id().isEmpty())
        {
            mViewHolder.tvTIN.setText(currentListData.getTax_id());
        }
...
//            mViewHolder.tvTIN.setText("Area Name: " + currentListData.getTemp_tax_id());
            mViewHolder.tvTIN.setText(currentListData.getMiddle_name());
        ...
        if(currentListData.getPhoto() == null || currentListData.getPhoto().equalsIgnoreCase("null") || currentListData.getPhoto().isEmpty())
        {
            ...
            char myChar = currentListData.getFirst_name().charAt(0);


            String str = Character.toString(myChar).toUpperCase();
            int tColor = mColorGenerator.getColor(myChar);
