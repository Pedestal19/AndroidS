 ...
 */
public class TaxPayersAdapter extends BaseAdapter {
    ...
    public TaxPayersAdapter(Context context, ArrayList<Taxpayer> myList) {
        this.myList = myList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mViewHolder.tvFullName.setText(currentListData.getSurname() + " " + currentListData.getFirst_name());
        mViewHolder.tvViewDate.setText(currentListData.getRegistered_on());
        if(currentListData.getTax_id() != null && !currentListData.getTax_id().equalsIgnoreCase("null") && !currentListData.getTax_id().isEmpty())
        {
            mViewHolder.tvTIN.setText("Area: " + currentListData.getTax_id());
        }
        ...
        {
            mViewHolder.tvTIN.setText("Area: " + currentListData.getTemp_tax_id());
        }
        else {
