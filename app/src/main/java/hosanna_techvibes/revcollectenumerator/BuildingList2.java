...
public class BuildingList2 extends AppCompatActivity {
    private static final String TAG = "BuildingList2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app.setActiveActivity(BuildingList2.this);
...
*/
    ...
    private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(BuildingList2.this);
...
finish();
    ...
    void Info(){
        ...
        adb.setTitle("Info");
        adb.setIcon(R.mipmap.ic_launcher);
        adb.setMessage("Please select a building to add an apartment to");
